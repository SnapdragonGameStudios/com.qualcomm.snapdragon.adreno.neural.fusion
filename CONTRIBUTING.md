# Contributing to Snapdragon™ Game Super Resolution for Unity
...
1. [Fork](https://github.com/SnapdragonGameStudios/com.qualcomm.snapdragon.adreno.neural.fusion/fork) and clone the repository.

    ```bash
    git clone https://github.com/<username>/com.qualcomm.snapdragon.adreno.neural.fusion.git
    ```
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/SnapdragonGameStudios/com.qualcomm.snapdragon.adreno.neural.fusion.git
    ```
...
1. [Submit a pull request](https://github.com/SnapdragonGameStudios/com.qualcomm.snapdragon.adreno.neural.fusion/pulls) from your branch to `main`.
